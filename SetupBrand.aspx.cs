...
{
    public partial class SetupBrand : System.Web.UI.Page
    {
        ...
        public void GenerateTable()
        {
            ...
            string sqlstring = "SELECT * from dbo.Brand; ";
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (txtSite.Text != "")
            {
                ...
                sqlcmd.CommandText = "select * from Brand where Brand = @BrandName and AutoID != @Auto_ID";
                sqlcmd.Connection = conn.objConnection;
                sqlcmd.Parameters.AddWithValue("@BrandName", SqlDbType.NVarChar).Value = txtSite.Text.Trim();
                ...
                else
                {
                    ...
                    {
                        // Insert Record
                        sqlcom.CommandText = "INSERT INTO dbo.Brand (Brand) VALUES " +
                            "(@Brand) ";


                        sqlcom.Parameters.AddWithValue("@Brand", SqlDbType.Int).Value = txtSite.Text;
                    ...
                    {
                        //update record
                        sqlcom.CommandText = "UPDATE dbo.Brand SET " +
                            "Brand = @Brand " +
                            " WHERE AutoID = @ID";

                        sqlcom.Parameters.AddWithValue("@ID", SqlDbType.Int).Value = txtID.Text;
                        sqlcom.Parameters.AddWithValue("@Brand", SqlDbType.VarChar).Value = txtSite.Text;
