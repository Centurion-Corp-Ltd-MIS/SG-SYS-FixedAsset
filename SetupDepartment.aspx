<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupDepartment.aspx.cs" Inherits="FixedAssetSystem.SetupDepartment" %>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                         <asp:Label ID="Label3" runat="server" class="h4 m-0 font-weight-bold text-secondary">Department Details : </asp:Label>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <asp:Label ID="lblDorm1" runat="server" class="h3 m-0">Department Tab</asp:Label>
                            ...
                            <div class="col-xl-12 col-lg-12">
                                <div class="card shadow mb-4 ">
                                    ...
                                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <asp:Label ID="Label24" runat="server" class="m-0 font-weight-bold text-primary">Department Field</asp:Label>
                                    ...
                                    <div class="card-body" style="overflow:auto; height:500px;">
                                        ...
                                        <asp:GridView ID="gvTable" runat="server" class="table table-bordered" Width="80%" CellSpacing="0" AutoGenerateColumns="false" HeaderStyle-HorizontalAlign="right" style="margin-left:10%; margin-right:10%">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Department" HeaderText="Department" ItemStyle-HorizontalAlign="right" />
                              ...
                              <div class="col-xl-12 col-lg-12">
                                <div class="card shadow mb-4 ">
                                    <!-- Card Header - Dropdown -->
                                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <asp:Label ID="Label12" runat="server" class="m-0 font-weight-bold text-primary">Add Department</asp:Label>
                                    ...
                                    <div class="card-body" style="margin-left:40%">
                                        <asp:UpdatePanel ID="panel_insert" runat="server" UpdateMode="Conditional"> 
                                            ...
                                            <br />
                                            <asp:Label runat="server" ID="lblSite" class="col-sm-4 control-label" Text="Department Name:"></asp:Label><span ID="span1" runat="server" visible="false" style="color:red; font-weight:bold; font-size:20px">*</span>
