...
namespace FixedAssetSystem
{
    public partial class SetupDepartment : System.Web.UI.Page
    {
        ...
        public void GenerateTable()
        {
            ...
            string sqlstring = "SELECT * from dbo.Department; ";
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (txtSite.Text != "")
            {
                ...
                sqlcmd.CommandText = "select * from Department where Department = @Departmentname and AutoID != @Auto_ID";
                sqlcmd.Connection = conn.objConnection;
                sqlcmd.Parameters.AddWithValue("@Departmentname", SqlDbType.NVarChar).Value = txtSite.Text.Trim();
                ...
                else
                {
                    ...
                    {
                        // Insert Record
                        sqlcom.CommandText = "INSERT INTO dbo.Department (Department) VALUES " +
                            "(@Department) ";


                        sqlcom.Parameters.AddWithValue("@Department", SqlDbType.Int).Value = txtSite.Text;
                    ...
                    {
                        //update record
                        sqlcom.CommandText = "UPDATE dbo.Department SET " +
                            "Department = @Department " +
                            " WHERE AutoID = @ID";

                        sqlcom.Parameters.AddWithValue("@ID", SqlDbType.Int).Value = txtID.Text;
                        sqlcom.Parameters.AddWithValue("@Department", SqlDbType.VarChar).Value = txtSite.Text;
